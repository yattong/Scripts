...
var logType = "Action";
var logName = "getResourceElementCategory"; // This must be set to the name of the action
var Logger = System.getModule("com.vodafone.agilecloud.library.util").logout(logType, logName);
